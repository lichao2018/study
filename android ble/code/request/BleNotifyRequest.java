...
public class BleNotifyRequest extends BleRequest implements IBleWriteDescriptorResponse {
    private UUID mService;
    private UUID mCharater;

    public BleNotifyRequest(UUID service, UUID character, IBleResponse response) {
        super(response);
        mService = service;
        mCharater = character;
    }
    ...
    public void executeRequest() {
        if(!mWorker.setCharacterNotify(mService, mCharater, true)){
